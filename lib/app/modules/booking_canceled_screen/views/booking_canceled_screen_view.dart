...
import 'package:owner_app/app/modules/booking_canceled_screen/controllers/booking_canceled_screen_controller.dart';
...
class BookingCanceledScreenView extends GetView<BookingCanceledScreenController> {
  const BookingCanceledScreenView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetX<BookingCanceledScreenController>(
        init: BookingCanceledScreenController(),
        builder: (controller) {
          return Container(
            ...
            child: StreamBuilder(
                ...
                builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                  if (snapshot.hasError) {
                    return Center(
                      child: Constant.showEmptyView(message: "No canceled parking found".tr),
                    );
                  }
                  ...
                  return snapshot.data!.docs.isEmpty
                      ? Center(child: Constant.showEmptyView(message: "No canceled parking found".tr))
                      : ListView.builder(
                          shrinkWrap: true,
                                                    ...
                                                    children: [
                                                      ...
                                                      InkWell(
                                                        ...
                                                        child: Text(
                                                          "View Details".tr,
                                                          style:
                                                              const TextStyle(color: AppColors.yellow04, fontFamily: AppThemData.semiBold),
                                                        ),
                                                      )
                                                    ],
                                                  ),
