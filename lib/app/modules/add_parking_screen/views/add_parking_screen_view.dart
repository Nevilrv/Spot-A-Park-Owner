    ...
    return GetX<AddParkingScreenController>(
        ...
        builder: (controller) {
          return Scaffold(
              ...
              appBar: UiInterface().customAppBar(context, controller.parkingModel.value.id != null ? "Edit Parking".tr : "Add Parking".tr,
                  backgroundColor: AppColors.lightGrey02),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                        ...
                                        children: [
                                          ...
                                          Transform.scale(
                                            ...
                                            child: CupertinoSwitch(
                                              ...
                                              value: controller.parkingStatus.value,
                                              onChanged: (value) {
                                                controller.parkingStatus.value = value;
                                              },
                                            ),
                                          )
                                        ],
                                    ...
                                    const SizedBox(height: 10),
                                     Text(
                                      "Parking For".tr,
                                      style: const TextStyle(fontSize: 16, fontFamily: AppThemData.semiBold, color: AppColors.darkGrey10),
                                    ),
                                    ...
                                    Column(
                                      children: [
                                        SelectParkingTypeWidget(
                                          ...
                                          value: "2",
                                          imageAsset: "assets/icons/ic_bike.svg",
                                        ),
                                        const Padding(
                                            ...
                                            child: Container(
                                              ...
                                              child: ClipRRect(
                                                  ...
                                                  child: GridView.builder(
                                                    ...
                                                    itemCount: controller.parkingImages.length,
                                                    gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                                                        crossAxisCount: 3, mainAxisSpacing: 5, crossAxisSpacing: 5),
                                                    itemBuilder: (context, index) {
                                                      return Constant.hasValidUrl(controller.parkingImages[index]) == false
                                                          ? ClipRRect(
                                                              borderRadius: BorderRadius.circular(5),
                                                              child: Image.file(
                                                                File(controller.parkingImages[index]),
                                                                height: Responsive.height(20, context),
                                                          ...
                                                          : ClipRRect(
                                                              ...
                                                              child: NetworkImageWidget(
                                                                borderRadius: 0,
                                                                imageUrl: controller.parkingImages[index].toString(),
                                                                fit: BoxFit.fill,
                                                                height: Responsive.height(20, context),
                                                                width: Responsive.width(80, context),
                                                              ),
                                            ...
                                            child: DottedBorder(
                                              ...
                                              child: Container(
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                      const Icon(Icons.image, color: AppColors.darkGrey10, size: 32),
                                                      const SizedBox(
                                                        height: 5,
                                                      ),
                                                      Text(
                                    ...
                                    TextFieldWidgetPrefix(
                                      validator: (value) => value != null && value.isNotEmpty ? null : 'Parking name required'.tr,
                                      ...
                                      controller: controller.parkingNameController.value,
                                      onPress: () {},
                                    ),
                                    InkWell(
                                      onTap: () async {
                                      ...
                                      child: TextFieldWidgetPrefix(
                                        validator: (value) => value != null && value.isNotEmpty ? null : 'Address required'.tr,
                                        titleFontFamily: AppThemData.semiBold,
                                        titleFontSize: 16,
                                        prefix: Padding(
                                          padding: const EdgeInsets.all(12.0),
                                          child: SvgPicture.asset("assets/icons/ic_place_marker.svg"),
                                        ),
                                        title: "Address".tr,
                                        titleColor: AppColors.darkGrey10,
                                    ...
                                    TextFieldWidgetPrefix(
                                      ...
                                      prefix: Padding(
                                        padding: const EdgeInsets.all(12.0),
                                        child: SvgPicture.asset("assets/icons/ic_currency.svg"),
                                      ),
                                    ...
                                    TextFieldWidgetPrefix(
                                      ...
                                      prefix: Padding(
                                        padding: const EdgeInsets.all(12.0),
                                        child: SvgPicture.asset("assets/icons/ic_parkingspaces.svg"),
                                      ),
                                      titleColor: AppColors.darkGrey10,
                                    ...
                                    TextFieldWidgetPrefix(
                                      validator: (value) => value != null && value.isNotEmpty ? null : 'Start time required'.tr,
                                      titleFontFamily: AppThemData.semiBold,
                                      titleFontSize: 16,
                                      titleColor: AppColors.darkGrey10,
                                      title: "Start Time".tr,
                                    ...
                                    TextFieldWidgetPrefix(
                                      validator: (value) => value != null && value.isNotEmpty ? null : 'End time required'.tr,
                                      titleFontFamily: AppThemData.semiBold,
                                      titleFontSize: 16,
                                      titleColor: AppColors.darkGrey10,
                                      title: "End Time",
                                                ...
                                                children: [
                                                  Theme(
                                                    ...
                                                    child: CheckboxListTile(
                                                      ...
                                                      value: controller.selectedParkingFacilitiesList
                                                        ...
                                                        children: [
                                                          ...
                                                          Text(item.name.toString(),
                                                              style: const TextStyle(
                                                                  color: AppColors.darkGrey06, fontFamily: AppThemData.medium)),
                                                        ],
                                                      ),
                                                      onChanged: (value) {
                                                        if (value == true) {
                              ...
                              Expanded(
                                child: Visibility(
                                  ...
                                  child: ButtonThem.buildButton(
                                    ...
                                    txtSize: 16,
                                    context,
                                    title: controller.parkingModel.value.id != null ? "Update Detail".tr : "Save".tr,
                                    txtColor: AppColors.lightGrey01,
                                    bgColor: AppColors.darkGrey10,
                                    onPress: () {
                                      if (controller.formKey.value.currentState!.validate()) {
                                        if (controller.parkingImages.isEmpty) {
                                          ShowToastDialog.showToast("Please Add Images".tr);
                                          return;
                                        }
...
class SelectParkingTypeWidget extends StatelessWidget {
  SelectParkingTypeWidget({super.key, this.controller, this.value, this.imageAsset});
                ...
                Row(
                  children: [
                    Padding(
                      ...
                      child: SvgPicture.asset(
                        // ignore: deprecated_member_use
                        imageAsset!, color: AppColors.darkGrey04, height: 22, width: 22,
                      ),
                    ),
                    Text("$value Wheel".tr, style: const TextStyle(fontFamily: AppThemData.medium)),
                  ],
                ),
                Radio(
                  value: value!,
                  ...
                  children: [
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          IconButton(
                              onPressed: () => controller.pickMultiImages(source: "Camera"),
                              icon: const Icon(
                                Icons.camera_alt,
                                size: 32,
                              )),
