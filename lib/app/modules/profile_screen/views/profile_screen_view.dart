...
import 'package:owner_app/app/widget/dialogue_box_widget.dart';
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Center(
                                child: Padding(
                                  ...
                                  child: ButtonThem.buildButton(
                                    ...
                                    onPress: () {
                                      Get.toNamed(Routes.EDIT_PROFILE_SCREEN, arguments: {"ownerModel": controller.ownerModel.value})
                                          ?.then((value) {
                              ...
                              menuItemWidget(
                                ...
                                svgImage: "assets/icons/ic_bank.svg",
                              ),
                              const SizedBox(
                                height: 16,
                              ),
  ...
  return GetBuilder<ProfileScreenController>(builder: (controller) {
    return ListTile(
      ...
      leading: SvgPicture.asset(
        svgImage,
        color: title == "Log Out".tr || title == "Delete Account".tr ? AppColors.red04 : AppColors.darkGrey05,
        height: 26,
      ),
      title: Row(
        children: [
          Expanded(
            child: Text(title.tr,
                style: TextStyle(
                  ...
                  color: title.tr == "Log Out".tr || title == "Delete Account".tr ? AppColors.red04 : AppColors.darkGrey08,
                )),
          ),
          if (title.tr == "Language".tr)
            Text(controller.selectedLanguage.value.name.toString(),
