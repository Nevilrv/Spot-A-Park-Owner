...
class OngoingScreenView extends GetView<OngoingScreenController> {
  const OngoingScreenView({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return GetX<OngoingScreenController>(
        init: OngoingScreenController(),
        builder: (controller) {
          return Container(
            ...
            child: StreamBuilder(
                ...
                builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                  if (snapshot.hasError) {
                    return Center( child: Constant.showEmptyView(message: "No ongoing parking found".tr),);
                  }
                  ...
                  return snapshot.data!.docs.isEmpty
                      ? Center(
                      child: Constant.showEmptyView(message: "No ongoing parking found".tr)
                        )
                      : ListView.builder(
                          shrinkWrap: true,
